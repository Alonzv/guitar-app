...
export const UI: Record<Lang, UIStrings> = {
  en: {
    ...
    enharmonicHint: 'Right pitch, but that letter is already used — this scale needs a different letter here.',
  ...
  he: {
    ...
    enharmonicHint: 'הצליל נכון, אבל האות הזאת כבר בשימוש — כאן הסולם צריך אות אחרת.',
