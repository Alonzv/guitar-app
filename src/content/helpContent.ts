...
export const HELP: Record<string, HelpEntry> = {
  ...
  'chords:finder': {
    ...
    he: {
      title: 'לפי שם',
      body: 'בוחרים אקורד לפי שורש וסוג (מז׳ור, מינור, ספתה…). האפליקציה מציגה על הגריף אצבועים נגישים לאורך הצוואר — הקש על אחד כדי לשמוע. אפשר להוסיף אקורדים לפרוגרסיה, לשמור אותה באזור האישי או לשלוח ל-Voicings.',
    },
  },
  'chords:builder': {
    en: {
    ...
    he: {
      title: 'לפי אוזן',
      body: 'מניחים תווים על הגריף והאפליקציה מזהה בזמן אמת איזה אקורד בניתם — כולל היפוכים ושמות חלופיים. מצוין כדי להבין צורה שמצאתם באוזן.',
    },
  },
  'chords:analyzer': {
    en: {
  ...
  'scales:explorer': {
    ...
    he: {
      title: 'מגלה הסולמות',
      body: 'בוחרים שורש וסולם/מוד ורואים את כל התווים על הגריף, צבועים לפי דרגה. אפשר לנגן כדי לשמוע את הצליל, ולהשתמש בזה כמפה לאלתור בסולם.',
    },
  },
  'scales:triads': {
    en: {
